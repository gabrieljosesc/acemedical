...
export default function ProductCard({ product }: { product: CatalogProduct }) {
  ...
  return (
    ...
    >
      <div
        className={`h-[168px] border-b border-line relative flex items-center justify-center ${
          product.image ? "bg-card" : "bg-gradient-to-br from-teal-tint to-transparent"
        }`}
      >
        {product.image ? (
          <Image
        ...
        <span
          className={`absolute top-2.5 left-2.5 z-10 font-mono text-[9px] tracking-wide px-1.5 py-0.5 rounded-full inline-flex items-center gap-1.5 shadow-[0_1px_4px_rgba(8,40,32,0.12)] ${
            stockLabel === "in-stock"
